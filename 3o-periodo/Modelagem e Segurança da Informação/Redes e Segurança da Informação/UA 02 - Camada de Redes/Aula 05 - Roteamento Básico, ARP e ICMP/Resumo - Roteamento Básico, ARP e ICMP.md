...
## UA 2 - Camada de Redes - Aula 05: Roteamento Básico, ARP e ICMP
...
> **Aula:** 05 - Roteamento Básico, ARP e ICMP  
> **Carga de Vídeo:** ~26 min 09 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Roteamento Básico, ARP e ICMP.pdf`
- [ ] `PDF de Slides`: `Slides - Roteamento Básico, ARP e ICMP.pdf`
...
- **Parte 01:** Roteamento Básico - ARP ICMP (10:49) - *Prof. Fabrício Melo*
- **Parte 02:** Roteamento Básico - ARP ICMP II (07:33) - *Prof. Fabrício Melo*
- **Parte 03:** Roteamento Básico - ARP ICMP III (07:47) - *Prof. Fabrício Melo*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de Roteamento Básico, ARP e ICMP.
...
```mermaid
flowchart TD
    A["Roteamento Básico, ARP e ICMP"] --> B["Conceito Principal"]
