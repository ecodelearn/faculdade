...
## UA 4 - Segurança e Solução de Problemas - Aula 04: Metodologias de Solução de Problemas
...
> **Aula:** 04 - Metodologias de Solução de Problemas  
> **Carga de Vídeo:** ~26 min 11 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Metodologias de Solução de Problemas.pdf`
- [ ] `PDF de Slides`: `Slides - Metodologias de Solução de Problemas.pdf`
...
- **Parte 01:** Metodologias de Solução de Problemas (06:36) - *Prof. Fabrício Melo*
- **Parte 02:** Metodologias de Solução de Problemas II (08:41) - *Prof. Fabrício Melo*
- **Parte 03:** Metodologias de Solução de Problemas III (10:54) - *Prof. Fabrício Melo*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de Metodologias de Solução de Problemas.
...
```mermaid
flowchart TD
    A["Metodologias de Solução de Problemas"] --> B["Conceito Principal"]
