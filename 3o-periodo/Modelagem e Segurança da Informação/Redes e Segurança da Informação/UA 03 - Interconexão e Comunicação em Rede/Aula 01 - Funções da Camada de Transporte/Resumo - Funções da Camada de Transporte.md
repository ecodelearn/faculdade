...
## UA 3 - Interconexão e Comunicação em Rede - Aula 01: Funções da Camada de Transporte
...
> **Aula:** 01 - Funções da Camada de Transporte  
> **Carga de Vídeo:** ~23 min 47 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Funções da Camada de Transporte.pdf`
- [ ] `PDF de Slides`: `Slides - Funções da Camada de Transporte.pdf`
...
- **Parte 01:** Funções da Camada de Transporte (07:05) - *Prof. Fabrício Melo*
- **Parte 02:** Funções da Camada de Transporte II (07:23) - *Prof. Fabrício Melo*
- **Parte 03:** Funções da Camada de Transporte III (09:19) - *Prof. Fabrício Melo*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de Funções da Camada de Transporte.
...
```mermaid
flowchart TD
    A["Funções da Camada de Transporte"] --> B["Conceito Principal"]
