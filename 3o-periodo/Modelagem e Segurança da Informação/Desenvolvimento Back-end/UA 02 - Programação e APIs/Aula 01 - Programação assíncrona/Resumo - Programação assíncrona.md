...
## UA 2 - Programação e APIs - Aula 01: Programação assíncrona
...
> **Aula:** 01 - Programação assíncrona  
> **Carga de Vídeo:** ~31 min 00 s (4 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Programação assíncrona.pdf`
- [ ] `PDF de Slides`: `Slides - Programação assíncrona.pdf`
...
- **Parte 01:** Programação Assíncrona (05:46) - *Prof. Denis Gonçalves Cople*
- **Parte 02:** Programação Assíncrona II (10:55) - *Prof. Denis Gonçalves Cople*
- **Parte 03:** Programação Assíncrona III (07:20) - *Prof. Denis Gonçalves Cople*
- **Parte 04:** Programação Assíncrona IV (06:59) - *Prof. Denis Gonçalves Cople*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Programação assíncrona**.
...
```mermaid
flowchart TD
    A["Programação assíncrona"] --> B["Conceito Principal"]
