...
## UA 1 - Arquitetura - Aula 05: Call Stack e Event Loop I
...
> **Aula:** 05 - Call Stack e Event Loop I  
> **Carga de Vídeo:** ~30 min 43 s (4 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Call Stack e Event Loop.pdf`
- [ ] `PDF de Slides`: `Slides - Call Stack e Event Loop I.pdf`
...
- **Parte 01:** Call Stack e Evento Loop I (09:12) - *Prof. Denis Gonçalves Cople*
- **Parte 02:** Call Stack e Evento Loop II (08:02) - *Prof. Denis Gonçalves Cople*
- **Parte 03:** Call Stack e Evento Loop III (07:14) - *Prof. Denis Gonçalves Cople*
- **Parte 04:** Call Stack e Evento Loop IV (06:15) - *Prof. Denis Gonçalves Cople*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Call Stack e Event Loop I**.
...
```mermaid
flowchart TD
    A["Call Stack e Event Loop I"] --> B["Conceito Principal"]
