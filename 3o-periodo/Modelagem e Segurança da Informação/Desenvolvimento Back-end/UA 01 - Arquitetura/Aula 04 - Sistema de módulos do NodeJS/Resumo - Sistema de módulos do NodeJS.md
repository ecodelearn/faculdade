...
## UA 1 - Arquitetura - Aula 04: Sistema de módulos do NodeJS
...
> **Aula:** 04 - Sistema de módulos do NodeJS  
> **Carga de Vídeo:** ~30 min 27 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Sistema de módulos do NodeJS.pdf`
- [ ] `PDF de Slides`: `Slides - Sistema de módulos do NodeJS.pdf`
...
- **Parte 01:** Sistema de Módulos do NodeJS I (10:36) - *Prof. Denis Gonçalves Cople*
- **Parte 02:** Sistema de Módulos do NodeJS II (08:39) - *Prof. Denis Gonçalves Cople*
- **Parte 03:** Sistema de Módulos do NodeJS III (11:12) - *Prof. Denis Gonçalves Cople*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Sistema de módulos do NodeJS**.
...
```mermaid
flowchart TD
    A["Sistema de módulos do NodeJS"] --> B["Conceito Principal"]
