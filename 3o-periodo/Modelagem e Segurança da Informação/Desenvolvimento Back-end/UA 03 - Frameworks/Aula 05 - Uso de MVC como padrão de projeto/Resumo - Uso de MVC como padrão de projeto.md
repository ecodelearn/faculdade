...
## UA 3 - Frameworks - Aula 05: Uso de MVC como padrão de projeto

> **Curso:** Gestão da TI | **Período:** 3º Período  
> **Módulo:** Modelagem e Segurança da Informação  
> **Disciplina:** Desenvolvimento Back-end  
> **Unidade:** UA 3 - Frameworks  
> **Aula:** 05 - Uso de MVC como padrão de projeto  
> **Carga de Vídeo:** ~32 min 26 s (4 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Uso de MVC como padrão de projeto.pdf`
- [ ] `PDF de Slides`: `Slides - Uso de MVC como padrão de projeto.pdf`
...
- **Parte 01:** Uso de MVC como Padrão de Projeto (08:17) - *Prof. Denis Gonçalves Cople*
- **Parte 02:** Uso de MVC como Padrão de Projeto II (08:14) - *Prof. Denis Gonçalves Cople*
- **Parte 03:** Uso de MVC como Padrão de Projeto III (08:34) - *Prof. Denis Gonçalves Cople*
- **Parte 04:** Uso de MVC como Padrão de Projeto IV (07:21) - *Prof. Denis Gonçalves Cople*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Uso de MVC como padrão de projeto**.
...
```mermaid
flowchart TD
    A["Uso de MVC como padrão de projeto"] --> B["Conceito Principal"]
