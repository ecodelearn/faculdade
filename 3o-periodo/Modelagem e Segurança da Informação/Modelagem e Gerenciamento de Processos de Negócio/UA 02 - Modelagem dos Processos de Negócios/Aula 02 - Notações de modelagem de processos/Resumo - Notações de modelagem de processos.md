...
## UA 2 - Modelagem dos Processos de Negócios - Aula 02: Notações de modelagem de processos
...
> **Unidade:** UA 2 - Modelagem dos Processos de Negócios  
> **Aula:** 02 - Notações de modelagem de processos  
> **Carga de Vídeo:** ~30 min 30 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Notações de Modelagem de Processos (BPMN, EPC, UML e IDEF).pdf`
- [ ] `PDF de Slides`: `Slides - Notações de modelagem de processos.pdf`
...
- **Parte 01:** Notações de Modelagem de Processos (BPMN, EPC, UML E IDEF) (10:08) - *Prof. Michel Emerson Barros Costa*
- **Parte 02:** Notações de Modelagem de Processos (BPMN, EPC, UML E IDEF) II (10:09) - *Prof. Michel Emerson Barros Costa*
- **Parte 03:** Notações de Modelagem de Processos (BPMN, EPC, UML E IDEF) III (10:13) - *Prof. Michel Emerson Barros Costa*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Notações de modelagem de processos**.
...
```mermaid
flowchart TD
    A["Notações de modelagem de processos"] --> B["Conceito Principal"]
