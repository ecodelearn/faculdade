...
## UA 2 - Modelagem dos Processos de Negócios - Aula 05: Problemas de modelagem
...
> **Aula:** 05 - Problemas de modelagem  
> **Carga de Vídeo:** ~30 min 56 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Problemas de Modelagem.pdf`
- [ ] `PDF de Slides`: `Slides - Problemas de modelagem.pdf`
...
- **Parte 01:** Problemas de Modelagem (10:10) - *Prof. Michel Emerson Barros Costa*
- **Parte 02:** Problemas de Modelagem II (10:09) - *Prof. Michel Emerson Barros Costa*
- **Parte 03:** Problemas de Modelagem III (10:37) - *Prof. Michel Emerson Barros Costa*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Problemas de modelagem**.
...
```mermaid
flowchart TD
    A["Problemas de modelagem"] --> B["Conceito Principal"]
