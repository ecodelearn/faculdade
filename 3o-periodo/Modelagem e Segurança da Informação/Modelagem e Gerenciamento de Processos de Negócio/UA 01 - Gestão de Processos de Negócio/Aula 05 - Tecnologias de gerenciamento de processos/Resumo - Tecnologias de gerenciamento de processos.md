...
## UA 1 - Gestão de Processos de Negócio - Aula 05: Tecnologias de gerenciamento de processos
...
> **Unidade:** UA 1 - Gestão de Processos de Negócio  
> **Aula:** 05 - Tecnologias de gerenciamento de processos  
> **Carga de Vídeo:** ~30 min 24 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Tecnologias de Gerenciamento de Processos.pdf`
- [ ] `PDF de Slides`: `Slides - Tecnologias de gerenciamento de processos.pdf`
...
- **Parte 01:** Tecnologias de Gerenciamento de Processos (10:08) - *Prof. Michel Emerson Barros Costa*
- **Parte 02:** Tecnologias de Gerenciamento de Processos II (10:08) - *Prof. Michel Emerson Barros Costa*
- **Parte 03:** Tecnologias de Gerenciamento de Processos III (10:08) - *Prof. Michel Emerson Barros Costa*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Tecnologias de gerenciamento de processos**.
...
```mermaid
flowchart TD
    A["Tecnologias de gerenciamento de processos"] --> B["Conceito Principal"]
