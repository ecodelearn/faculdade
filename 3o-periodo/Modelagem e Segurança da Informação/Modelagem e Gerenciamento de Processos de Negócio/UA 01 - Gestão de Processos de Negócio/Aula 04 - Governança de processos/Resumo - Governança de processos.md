...
## UA 1 - Gestão de Processos de Negócio - Aula 04: Governança de processos
...
> **Aula:** 04 - Governança de processos  
> **Carga de Vídeo:** ~30 min 37 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Governança de Processos.pdf`
- [ ] `PDF de Slides`: `Slides - Governança de processos.pdf`
...
- **Parte 01:** Governança de Processos (10:11) - *Prof. Michel Emerson Barros Costa*
- **Parte 02:** Governança de Processos II (10:13) - *Prof. Michel Emerson Barros Costa*
- **Parte 03:** Governança de Processos III (10:13) - *Prof. Michel Emerson Barros Costa*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Governança de processos**.
...
```mermaid
flowchart TD
    A["Governança de processos"] --> B["Conceito Principal"]
