...
## UA 1 - Gestão de Processos de Negócio - Aula 03: Tipos e visões de processos
...
> **Aula:** 03 - Tipos e visões de processos  
> **Carga de Vídeo:** ~30 min 28 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Tipos e Visões de Processos.pdf`
- [ ] `PDF de Slides`: `Slides - Tipos e visões de processos.pdf`
...
- **Parte 01:** Tipos e Visões de Processos (10:07) - *Prof. Michel Emerson Barros Costa*
- **Parte 02:** Tipos e Visões de Processos II (10:13) - *Prof. Michel Emerson Barros Costa*
- **Parte 03:** Tipos e Visões de Processos III (10:08) - *Prof. Michel Emerson Barros Costa*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Tipos e visões de processos**.
...
```mermaid
flowchart TD
    A["Tipos e visões de processos"] --> B["Conceito Principal"]
