...
## UA 3 - Análise de Otimização, Desempenho e Transformação dos Processos de Negócio - Aula 01: Análise de processos e obtendo informações
...
> **Aula:** 01 - Análise de processos e obtendo informações  
> **Carga de Vídeo:** ~31 min 34 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Análise de Processos e Obtendo Informações.pdf`
- [ ] `PDF de Slides`: `Slides - Análise de processos e obtendo informações.pdf`
...
- **Parte 01:** Análise de Processos e Obtendo Informações (10:07) - *Prof. Michel Emerson Barros Costa*
- **Parte 02:** Análise de Processos e Obtendo Informações II (10:41) - *Prof. Michel Emerson Barros Costa*
- **Parte 03:** Análise de Processos e Obtendo Informações III (10:46) - *Prof. Michel Emerson Barros Costa*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Análise de processos e obtendo informações**.
...
```mermaid
flowchart TD
    A["Análise de processos e obtendo informações"] --> B["Conceito Principal"]
