...
## UA 3 - Análise de Otimização, Desempenho e Transformação dos Processos de Negócio - Aula 02: Análise de fluxo As-Is – To-Be, desenho de processos e simulação de Processos
...
> **Aula:** 02 - Análise de fluxo As-Is – To-Be, desenho de processos e simulação de Processos  
> **Carga de Vídeo:** ~31 min 26 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Análise de Fluxo AS-IS – TO-BE, Desenho de Processos e Simulação de Processos.pdf`
- [ ] `PDF de Slides`: `Slides - Análise de fluxo As-Is - To-Be, desenho de processos e simulação de Processos.pdf`
...
- **Parte 01:** Análise de Fluxo AS-IS - To-BE, Desenho de Processos e Simulação de Processos (10:13) - *Prof. Michel Emerson Barros Costa*
- **Parte 02:** Análise de Fluxo AS-IS - To-BE, Desenho de Processos e Simulação de Processos II (10:43) - *Prof. Michel Emerson Barros Costa*
- **Parte 03:** Análise de Fluxo AS-IS - To-BE, Desenho de Processos e Simulação de Processos III (10:30) - *Prof. Michel Emerson Barros Costa*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Análise de fluxo As-Is – To-Be, desenho de processos e simulação de Processos**.
...
```mermaid
flowchart TD
    A["Análise de fluxo As-Is – To-Be, desenho de processos e simulação de Processos"] --> B["Conceito Principal"]
