...
## UA 4 - Casos Práticos (TI) - Aula 03: Caso Prático -Solicitação de Férias
...
> **Unidade:** UA 4 - Casos Práticos (TI)  
> **Aula:** 03 - Caso Prático -Solicitação de Férias  
> **Carga de Vídeo:** ~30 min 28 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Caso Prático -Solicitação de Férias.pdf`
- [ ] `PDF de Slides`: `Slides - Caso Prático -Solicitação de Férias.pdf`
...
- **Parte 01:** Casos Práticos III (10:06) - *Prof. Michel Emerson Barros Costa*
- **Parte 02:** Casos Práticos III II (10:09) - *Prof. Michel Emerson Barros Costa*
- **Parte 03:** Casos Práticos III III (10:13) - *Prof. Michel Emerson Barros Costa*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Caso Prático -Solicitação de Férias**.
...
```mermaid
flowchart TD
    A["Caso Prático -Solicitação de Férias"] --> B["Conceito Principal"]
