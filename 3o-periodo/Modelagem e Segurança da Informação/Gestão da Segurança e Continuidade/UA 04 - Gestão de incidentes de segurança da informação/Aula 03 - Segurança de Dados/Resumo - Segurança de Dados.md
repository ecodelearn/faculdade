...
## UA 4 - Gestão de incidentes de segurança da informação - Aula 03: Segurança de Dados
...
> **Aula:** 03 - Segurança de Dados  
> **Carga de Vídeo:** ~25 min 24 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Segurança de Dados.pdf`
- [ ] `PDF de Slides`: `Slides - Segurança de Dados.pdf`
...
- **Parte 01:** Segurança de Dados (08:27) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 02:** Segurança de Dados II (07:53) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 03:** Segurança de Dados III (09:04) - *Prof. Francisco Adair dos Santos Júnior*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Segurança de Dados**.
...
```mermaid
flowchart TD
    A["Segurança de Dados"] --> B["Conceito Principal"]
