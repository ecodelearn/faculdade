...
## UA 4 - Gestão de incidentes de segurança da informação - Aula 02: Deep WEB e Dark Web
...
> **Aula:** 02 - Deep WEB e Dark Web  
> **Carga de Vídeo:** ~24 min 28 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Deep WEB e a Dark Web.pdf`
- [ ] `PDF de Slides`: `Slides - Deep WEB e Dark Web.pdf`
...
- **Parte 01:** Deep Web e Dark Web (08:43) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 02:** Deep Web e Dark Web II (07:49) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 03:** Deep Web e Dark Web III (07:56) - *Prof. Francisco Adair dos Santos Júnior*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Deep WEB e Dark Web**.
...
```mermaid
flowchart TD
    A["Deep WEB e Dark Web"] --> B["Conceito Principal"]
