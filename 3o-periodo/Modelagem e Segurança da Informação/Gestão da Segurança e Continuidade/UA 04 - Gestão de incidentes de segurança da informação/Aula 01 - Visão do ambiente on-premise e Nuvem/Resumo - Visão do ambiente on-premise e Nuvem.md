...
## UA 4 - Gestão de incidentes de segurança da informação - Aula 01: Visão do ambiente on-premise e Nuvem
...
> **Aula:** 01 - Visão do ambiente on-premise e Nuvem  
> **Carga de Vídeo:** ~25 min 44 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Visão do ambiente on-premise  e Nuvem.pdf`
- [ ] `PDF de Slides`: `Slides - Visão do ambiente on-premise e Nuvem.pdf`
...
- **Parte 01:** Visão do Ambiente On-premise e Nuvem (09:21) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 02:** Visão do Ambiente On-premise e Nuvem II (08:23) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 03:** Visão do Ambiente On-premise e Nuvem III (08:00) - *Prof. Francisco Adair dos Santos Júnior*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Visão do ambiente on-premise e Nuvem**.
...
```mermaid
flowchart TD
    A["Visão do ambiente on-premise e Nuvem"] --> B["Conceito Principal"]
