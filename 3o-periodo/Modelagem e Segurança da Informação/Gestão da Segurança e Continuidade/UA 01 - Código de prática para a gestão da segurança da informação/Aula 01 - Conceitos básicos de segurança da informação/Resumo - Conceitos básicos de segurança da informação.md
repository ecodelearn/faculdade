...
## UA 1 - Código de prática para a gestão da segurança da informação - Aula 01: Conceitos básicos de segurança da informação
...
> **Aula:** 01 - Conceitos básicos de segurança da informação  
> **Carga de Vídeo:** ~21 min 28 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Conceitos Básicos de Segurança da Informação.pdf`
- [ ] `PDF de Slides`: `Slides - Conceitos básicos de segurança da informação.pdf`
...
- **Parte 01:** Conceitos Básicos de Segurança da Informação (06:27) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 02:** Conceitos Básicos de Segurança da Informação II (06:50) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 03:** Conceitos Básicos de Segurança da Informação III (08:11) - *Prof. Francisco Adair dos Santos Júnior*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Conceitos básicos de segurança da informação**.
...
```mermaid
flowchart TD
    A["Conceitos básicos de segurança da informação"] --> B["Conceito Principal"]
