...
## UA 1 - Código de prática para a gestão da segurança da informação - Aula 02: Organizando a segurança da informação
...
> **Aula:** 02 - Organizando a segurança da informação  
> **Carga de Vídeo:** ~25 min 37 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Organizando a Segurança da Informação.pdf`
- [ ] `PDF de Slides`: `Slides - Organizando a segurança da informação.pdf`
...
- **Parte 01:** Organizando a Segurança da Informação (09:25) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 02:** Organizando a Segurança da Informação II (06:01) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 03:** Organizando a Segurança da Informação III (10:11) - *Prof. Francisco Adair dos Santos Júnior*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Organizando a segurança da informação**.
...
```mermaid
flowchart TD
    A["Organizando a segurança da informação"] --> B["Conceito Principal"]
