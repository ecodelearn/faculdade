...
## UA 3 - Plano de Continuidade de Negócio - Aula 03: Gerenciamento de Risco e normas no nível tático
...
> **Aula:** 03 - Gerenciamento de Risco e normas no nível tático  
> **Carga de Vídeo:** ~23 min 21 s (3 blocos de vídeo)

---

## 📂 Checklist de Materiais Baixados
- [ ] `PDF da Matéria`: `Gerenciamento de Risco e normas no nível tático.pdf`
- [ ] `PDF de Slides`: `Slides - Gerenciamento de Risco e normas no nível tático.pdf`
...
- **Parte 01:** Gerenciamento de Risco e Normas no Nível Tático (07:02) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 02:** Gerenciamento de Risco e Normas no Nível Tático II (09:14) - *Prof. Francisco Adair dos Santos Júnior*
- **Parte 03:** Gerenciamento de Risco e Normas no Nível Tático III (07:05) - *Prof. Francisco Adair dos Santos Júnior*

---

## 🎯 Objetivos de Aprendizagem
- [ ] Compreender os conceitos principais de **Gerenciamento de Risco e normas no nível tático**.
...
```mermaid
flowchart TD
    A["Gerenciamento de Risco e normas no nível tático"] --> B["Conceito Principal"]
